...
export function SelectedStudyCard({ study, onChatPress }: SelectedStudyCardProps) {
  return (
    <View style={styles.cardContainer}>
      <View style={styles.infoContainer}>
        <Text style={styles.title}>{study.titulo}</Text>
        <Text style={styles.researcher}>Pesquisador: {study.pesquisador.nomeFicticio}</Text>
      </View>
